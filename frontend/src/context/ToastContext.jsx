    ...
    <ToastContext.Provider value={{ addToast, removeToast }}>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2 pointer-events-none">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`pointer-events-auto flex items-center gap-3 w-80 max-w-sm p-4 rounded-xl shadow-lg border text-white transform transition-all duration-300 translate-y-0 opacity-100 animate-slide-in
